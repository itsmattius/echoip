...
# Free GeoLite2 mmdb mirror maintained at https://github.com/P3TERX/GeoLite.mmdb
GEOIP_MIRROR ?= https://github.com/P3TERX/GeoLite.mmdb/raw/download

geoip-download:
	mkdir -p data
	curl -fsSL -m 60 -o data/asn.mmdb     $(GEOIP_MIRROR)/GeoLite2-ASN.mmdb
	curl -fsSL -m 60 -o data/city.mmdb    $(GEOIP_MIRROR)/GeoLite2-City.mmdb
	curl -fsSL -m 60 -o data/country.mmdb $(GEOIP_MIRROR)/GeoLite2-Country.mmdb
